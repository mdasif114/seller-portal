...
import com.seller.empowerment.entity.Role;
...
public class UserServiceImpl implements UserService {
    ...
    public User save(UserRegistrationValidator registration) {
        User user = new User();
    ...
    private Collection mapRolesToAuthorities(Collection < Role > roles) {
        return roles.stream()
